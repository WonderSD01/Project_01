...
export default function About() {
  return (
    <section id="about" className="section-wrap">
      ...
      <MotionReveal>
        <div className="group overflow-hidden rounded-2xl border border-white/10 bg-surface-raised shadow-glass transition hover:shadow-fire-lg dark:bg-surface-raised">
          ...
          <div className="p-6 text-left">
            <p className="text-base leading-relaxed text-cream/85 dark:text-cream/85">
            ...
            <a
              ...
              className="mt-5 flex items-center gap-3 rounded-xl border border-fire-orange/30 bg-fire-orange/10 p-4 transition hover:border-fire-orange/50 hover:bg-fire-orange/15"
            >
              ...
              <div className="min-w-0 flex-1 text-left">
                <p className="font-bold text-cream">Antipolo del Norte, Lipa City</p>
                <p className="text-sm text-muted">Batangas, Philippines</p>
              </div>
